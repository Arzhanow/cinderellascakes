  ...
  garash: {
    ...
    panels: [
      ...
      },
      {
        ...
        layout: 'center',
        paragraph:
          'В нашата сладкарска къща пазим легендата като ритуал. Всяка платка се подготвя внимателно, а кадифеният шоколадов крем престоява 12 часа, за да развие онзи дълбок, благороден вкус. Орехите — ароматни и леко препечени — се добавят в точния момент, за да внесат характер и топлина.\nТака всяко парче „Гараш“ се превръща в миг от стара европейска приказка, в която шоколадът води, а елегантността остава вечна.',
      },
    ],
  },
  chococake: {
    hero: {
      ...
      intro:
        'Тази торта започва своето създаване в тиха вечер, когато кухнята забавя ритъма си и остава само ароматът на разтапящ се шоколад. Точно тогава Полина решава, че иска да поднесе на клиентите си най-вкусния и в същото време най-здравословен десерт. Нощ след нощ тя прави опити, променя, тества и усъвършенства рецептата до късни зори. Без брашно и без захар — оставяме истинското какао да заеме централната сцена, да води вкуса и да разказва своята дълбока, чиста история.',
    },
    panels: [
      {
        id: 'evening-ritual',
        ...
        layout: 'center',
        paragraph:
          'В късния следобед, когато градът притихва, майсторката запалва котлона и разтапя тъмен белгийски шоколад БЕЗ ЗАХАР – истински, натурален, кадифен. Без да търси прикритие в брашно и захар – „Нека говори какаото“, прошепва тя, и въздухът се изпълва с аромат на зрели какаови зърна и топла нотка на наслада.',
      },
      {
        id: 'discipline',
        order: 'II',
        eyebrow: 'Белтък & огън',
        title: 'Магията се случва',
        layout: 'right',
        paragraph:
          'Тя разбива белтъка до пухкави облаци, разпламенява огъня и оставя страстта да говори – любов към шоколада, сладост без никакви угризения, неопорочена – такава е тя: шоколадова и без захар, без брашно!',
      },
      {
        id: 'atelier-today',
        order: 'III',
        ...
        layout: 'center',
        paragraph:
          'И днес в Cinderella’s Cakes Поли пази тази легенда жива и споделя: „Правим нашата шоколадова торта без абсолютно никакво брашно и без захар. Това е първата торта, която създадох от здравословната ни линия. Направихме я не само за тези, които искат да се хранят по-здравословно, но с чисто сърце можем да кажем, че тази торта се консумира от хората с инсулинова резистентност и такива с непоносимост към глутена, от които обратната връзка е, че след консумация нивото на захарта не се покачва!“\nСемпла, но запомняща се! Със силен характер!',
      },
    ],
  },
}
