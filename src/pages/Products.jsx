...
const featuredProducts = [
  ...
  {
    id: 'chococake-slice',
    title: 'Шоколадова Zero Sugar Edition',
    slug: 'chococake',
    imageSrc: '/images/cakes/chococake/20250128_145756.jpg',
    imageAlt: 'Парче шоколадова торта без захар върху огледална глазура',
    badge: 'portfolio highlight',
    caption: 'Кремообразна текстура, разбита без грам пшенично брашно.',
    cta: 'Открий легендата',
  },
  {
    id: 'garash-detail',
  ...
  {
    id: 'chococake-glaze',
    title: 'Шоколадова торта · Glaze Motion',
    slug: 'chococake',
    imageSrc: '/images/cakes/chococake/20250128_150424.jpg',
    imageAlt: 'Шоколадова торта без захар, покрита с огледална глазура',
    badge: 'limited',
    caption: 'Покана за дегустации и кетъринг без компромиси.',
    cta: 'Открий легендата',
  },
]
